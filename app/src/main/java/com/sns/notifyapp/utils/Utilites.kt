...
Submit the assignment by Thursday.
    ...
    fun getNotifyListArr():ArrayList<NotifyData>{
        ...
        arr.add(NotifyData("A","a aaaaaaaaaa","gfdgfd",444444))
        arr.add(NotifyData("B","bbbbbbbbbbbb","gdfsgfg",5555555))
        arr.add(NotifyData("C","ccccccccccccc","fdgdfgfgdfg",455454445))
